...
class Connection(object):
	def __init__(self, pexpect):
		self.pexpect = pexpect
		self.received = []
	def on_read(self):
		self.received.append(self.sock.recv(50))
	def render(self):
		# linesplit is part of curtsies.formatstring
	...
	with FullscreenWindow() as window:
		...
		with Input() as input_generator:
			while True:
				...
				# Re-create 'a'
				# red at bottom
				# Create an FSArray of 10,80 - ie a 'screen'
				a = FSArray(10, 80)
				# Display the keypresses
				...
				# a has been set up - render it!
				window.render_to_terminal(a)


				# every time there is input (eg from pexpect.read_timeout) then we can go
				...
				for r in ready_to_read:
					if r is conn:
						...
						# input_generator is what gets the input... we won't need that I think?
